...
COMMENT ON COLUMN EXPENSE_ENTRY.PAYMENT_DATE IS 'Data do pagamento da despesa ou da primeira parcela';
...
CREATE INDEX IDX_EXPENSE_ENTRY_2023_USER_CATEGORY_NAME ON EXPENSE_ENTRY_2023(USER_ID, CATEGORY_NAME);
CREATE INDEX IDX_EXPENSE_ENTRY_2023_DT_EXPENSE ON EXPENSE_ENTRY_2023(ENTRY_DATE);

-- Índice para a partição de 2024
CREATE INDEX IDX_EXPENSE_ENTRY_2024_USER_CATEGORY_NAME ON EXPENSE_ENTRY_2024(USER_ID, CATEGORY_NAME);
CREATE INDEX IDX_EXPENSE_ENTRY_2024_DT_EXPENSE ON EXPENSE_ENTRY_2024(ENTRY_DATE);

-- Índice para a partição de 2025
CREATE INDEX IDX_EXPENSE_ENTRY_2025_USER_CATEGORY_NAME ON EXPENSE_ENTRY_2025(USER_ID, CATEGORY_NAME);
CREATE INDEX IDX_EXPENSE_ENTRY_2025_DT_EXPENSE ON EXPENSE_ENTRY_2025(ENTRY_DATE);

-- Índice para a partição de 2026
CREATE INDEX IDX_EXPENSE_ENTRY_2026_USER_CATEGORY_NAME ON EXPENSE_ENTRY_2026(USER_ID, CATEGORY_NAME);
CREATE INDEX IDX_EXPENSE_ENTRY_2026_DT_EXPENSE ON EXPENSE_ENTRY_2026(ENTRY_DATE);

-- Índice para a partição de 2027
CREATE INDEX IDX_EXPENSE_ENTRY_2027_USER_CATEGORY_NAME ON EXPENSE_ENTRY_2027(USER_ID, CATEGORY_NAME);
CREATE INDEX IDX_EXPENSE_ENTRY_2027_DT_EXPENSE ON EXPENSE_ENTRY_2027(ENTRY_DATE);

-- Índice para a partição de 2028
CREATE INDEX IDX_EXPENSE_ENTRY_2028_USER_CATEGORY_NAME ON EXPENSE_ENTRY_2028(USER_ID, CATEGORY_NAME);
